...
A disclaimer modal component that users must accept before using the application, typically used for AI/ML applications.
...
Displays application changelog information in a modal, automatically tracking and showing only unread entries to users.

## [NavigationBar](navigationbar.md)
A responsive navigation bar with language switching, disclaimer button, and customizable content areas with i18n integration.
